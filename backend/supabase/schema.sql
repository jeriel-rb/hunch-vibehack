...
-- ===== supabase/migrations/20260606133030_seal_started_rooms.sql =====
...
-- ===== supabase/migrations/20260606134540_consensus_voting.sql =====
...
-- ===== supabase/migrations/20260606143030_home_room_history.sql =====
...
-- ===== supabase/migrations/20260606141020_vote_current_options.sql =====
-- Keep place votes scoped to the active shortlist round.
...
begin
  ...
  order by count(*) desc, max(v.updated_at) asc
  limit 1;
...
-- ===== supabase/migrations/20260606150000_soften_consensus_copy.sql =====
-- Soften consensus-loop copy: a follow-up round should never reveal that the
-- room is split. Reframe the place-vote follow-up as a positive preference probe
-- so Hunch quietly hunts for shared ground instead of flagging disagreement.
...
-- ===== supabase/migrations/20260606160000_autoresolve_place_vote.sql =====
...
-- ===== supabase/migrations/20260606170000_user_credits.sql =====
